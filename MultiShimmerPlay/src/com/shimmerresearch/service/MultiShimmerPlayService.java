	            ...
	            case Shimmer.MESSAGE_READ:
	            	if ((msg.obj instanceof ObjectCluster)){	// within each msg an object can be include, objectclusters are used to represent the data structure of the shimmer device
	            	   ...
	            	   if (mEnableLogging==true){
		            	   shimmerLog1= mLogShimmer.get(objectCluster.mBluetoothAddress);
		            	   if (shimmerLog1!=null){
	            	   ...
	            	   int dataLimit = 200;
	            	   if (ofFormats != null) { 
		            	   formatCluster = ObjectCluster.returnFormatCluster(ofFormats,"CAL");
									        ...
									        if ((mMaxData[mPosition][2]-formatCluster.mData>0 || mMaxData[mPosition][2]>maxData) && mTriggerResting[mPosition][2] == true) {
				    							...
				    							if (mSoundIDArray[mPosition][2]!=-1){
				    								...
				    								if ((enabledSensors & Shimmer.SENSOR_MAG) ==0){
				    									...
				    									formatCluster = ObjectCluster.returnFormatCluster(ofFormatsMag,"CAL");
